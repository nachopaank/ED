...
/* ==============================================================================================
 * Implementa aqu� los m�todos pedidos
 * ==============================================================================================
 *
 *@ <answer>
 */
...
y se ejecutan una �nica vez, por tanto el m�todo esta en el orden de O(1) tanto el caso mejor como el peor

Coste attach;
El coste de este algortimo es constante ya que las instrucciones que presenta son meras asignaciones que son constantes
y se ejecutan una �nica vez, por tanto el m�todo esta en el orden de O(1) similar al coste de detach tanto el caso mejor como el peor
